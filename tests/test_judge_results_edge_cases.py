...
from portfolio_fdc.db_api.judge_repository import _extract_chart_id, _to_float_or_none
...
def seeded_edge_case_context() -> Iterator[SeededEdgeCaseContext]:
    ...
    try:
        # Insert processes
        for process_id in [process_id_float_chart, process_id_nan_feature, process_id_inf_feature]:
            con.execute(
                """
